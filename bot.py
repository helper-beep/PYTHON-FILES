...
bypass_list = ["your client id here"]
...
async def on_ready():
    ...
    await bot.change_presence(game = discord.Game(name = "in %s servers | c!help" % (servers)))
...
async def on_message(message):
    if message.content.upper().startswith("C!SAY"):
        ...
        await bot.send_message(message.channel, embed=embed)
        await bot.delete_message(message)
    elif message.content.upper().startswith("C!DATE"):
        ...
        await bot.send_message(message.channel, embed=embed)
    elif message.content.upper().startswith("C!8BALL"):
        ball =[]
        ...
        "Concentrate and ask again.", "Don't count on it.", "My reply is no.", "My sources say no.", "Outlook not so good.", "Very doubtful."]),color=0xF4BC0C)
        await bot.send_message(message.channel, embed=embed)
    elif message.content.upper().startswith("C!IAM"):
        ID = message.author.id
        AVATAR = message.author
        embed=discord.Embed(description=message.author.avatar_url + " " + "<@%s>" % (ID) + " " + ID, color=0xF4BC0C)
        await bot.send_message(message.channel, embed=embed)
        await bot.delete_message(message)
    elif message.content.upper().startswith("C!KID"):
        ...
        await bot.send_message(message.channel, embed=embed)
        await bot.delete_message(message)
    elif message.content.upper().startswith("C!ADULT"):
        mood = ["sad", "happy", "bored", "mad", "calm", "kind", "rude", "angry", "agitated", "thoughtful", "shrewd", "clumsy", "faulty", "funny", "crazy", "sleepy", "dumb", "miserable", "disgusted", "trusting", "friendly", "shameful", "piteous", "envious", "jealous", "lovelorn"]
        ...
        await bot.send_message(message.channel, embed=embed)
        await bot.delete_message(message)
    elif message.content.upper().startswith("C!MEMBERS"):
        ...
        await bot.send_message(message.channel, embed=embed)
        await bot.delete_message(message)
    elif message.content.upper().startswith("C!LINK"):
        ...
        await bot.send_message(message.channel, embed=embed)
        await bot.delete_message(message)
    elif message.content.upper().startswith("C!COMMAND"):
        args = message.content.split(" ")
        ID = message.author.id
